      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div className="max-w-2xl">
            {eyebrow && <div className="mb-3 text-[11px] font-semibold uppercase tracking-[0.18em] grad-gold-text">{eyebrow}</div>}
...
export function SectionHeader({ eyebrow, title, action }: { eyebrow?: string; title: string; action?: ReactNode }) {
  return (
    <div className="mb-5 flex items-end justify-between gap-4">
      <div>
        {eyebrow && <div className="mb-1.5 text-[10px] font-semibold uppercase tracking-[0.18em] grad-gold-text">{eyebrow}</div>}
