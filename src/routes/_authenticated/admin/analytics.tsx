...
export const Route = createFileRoute("/_authenticated/admin/analytics")({ component: AdminAnalytics });
  ...
  return (
    <CommandCenterContentShell>
      <CommandCenterPageHeader
        title="Analytics"
        description="Platform-wide metrics across all JESUP modules. Designed for future AI-powered reporting."
      />
      ...
      <Card className="mt-8">
        <CardContent className="p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Future analytics will include engagement trends, content performance, geographic reach,
